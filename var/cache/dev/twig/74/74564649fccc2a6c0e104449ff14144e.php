...
class __TwigTemplate_e70a97e2f27c65d30e809c81292dbcce extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 14, $this->source); })()), "livres", [], "any", false, false, false, 14))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["livre"]) {
                ...
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["livre"], "titre", [], "any", false, false, false, 18), "html", null, true);
                echo "</li>
                        ";
            }
...
";
    ...
    {
        return array (  135 => 24,  131 => 22,  127 => 20,  118 => 18,  114 => 17,  110 => 15,  108 => 14,  103 => 12,  99 => 11,  94 => 8,  84 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
